...
const LoadStockData = async (req, res) => {
 ...
 const csvFilePath = 'C:/project/Zerodha/market_data_service/complete.csv';
 ...
 fs.createReadStream(csvFilePath)
   ...
   .on('data', async (row) => {
     try {
       ...
       //sending data to opensearch17386
       var host = process.env.OPENSEARCH_HOST || "http://localhost:12415";
